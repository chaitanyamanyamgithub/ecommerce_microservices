...
const STAGE_3_DURATION = __ENV.STAGE_3_DURATION || '3m';
const STAGE_4_DURATION = __ENV.STAGE_4_DURATION || '3m';
const STAGE_5_DURATION = __ENV.STAGE_5_DURATION || '2m';
  ...
  scenarios: {
    flash_sale_catalog: {
      ...
      stages: [
        ...
        { duration: STAGE_3_DURATION, target: STAGE_3_VUS },
        { duration: STAGE_4_DURATION, target: STAGE_4_VUS },
